...
gulp.task('clean:build', callback => {
    ...
    var configStream = gulp.src('config/build-config.json',{allowEmpty:true})
        .pipe(vinylPaths(del));
...
gulp.task('minify-js-old', callback => {
...
gulp.task('minify-css-old', callback => {
...
gulp.task('copy:assets-old', callback => {
...
gulp.task('hash-css-app-old', callback => {
    return addToManifest(
...
gulp.task('hash-js-old', callback => {
    return addToManifest(
...
/** Minify the Javascript with requireJs optizer **/
gulp.task('minify-js-new', callback => {
...
/** Minify game and landing css into build dir **/
gulp.task('minify-css-new', callback => {
...
gulp.task('copy:assets-new', callback => {
...
gulp.task('hash-css-game-theme-new', callback => {
    return addToManifest(
...
gulp.task('hash-css-app-new', callback => {
    return addToManifest(
...
gulp.task('hash-js-new', callback => {
    return addToManifest(
